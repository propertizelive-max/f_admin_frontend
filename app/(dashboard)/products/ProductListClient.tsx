...
import { ProductTable, ProductTableSkeleton } from "@/components/product";
      ...
      >
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-16 gap-3">
            ...
            <p className="text-[14px] font-medium text-[#1a1c1b]">Failed to load products</p>
            <p className="text-[12px]" style={{ color: "var(--color-text-muted)" }}>
              Check your connection and try again.
            </p>
          </div>
        ) : (
          <ProductTable products={products} onDelete={handleDelete} hasSearch={hasSearch} />
        )}
